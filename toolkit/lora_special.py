...
class LoRASpecialNetwork(ToolkitNetworkMixin, LoRANetwork):
    ...
    def share_parameters_with(self, other: "LoRASpecialNetwork") -> None:
        ...
        Delegates to ``toolkit.lora_utils.main.share_network_parameters``.
        """
        from toolkit.lora_utils.main import share_network_parameters

        share_network_parameters(self, other)
