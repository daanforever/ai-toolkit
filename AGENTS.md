...
- Use subagents (models: `grok-4-5` or `composer-2.5`, NOT `*-fast`) STRICTLY to gather raw information (relevant files, definitions, dependencies, and command executions).
