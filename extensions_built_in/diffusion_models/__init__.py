...
from .z_image_diffsynth import ZImageDiffSynthModel, AI_TOOLKIT_EXTENSIONS as Z_IMAGE_DIFFSYNTH_EXTENSIONS
...
AI_TOOLKIT_EXTENSIONS = Z_IMAGE_DIFFSYNTH_EXTENSIONS
